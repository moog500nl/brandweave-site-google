...
const BlogListPage: React.FC = () => {
  return (
    <>
      <SEO
        title="Brandweave AI Blog | Insights on AI and Brand Strategy"
        description="Explore the Brandweave AI blog for the latest insights, tips, and news on AI brand perception, visibility, and navigating the future of brand discovery."
        keywords="AI brand blog, brand strategy insights, AI brand perception, brand intelligence articles, AI marketing blog"
        canonical="https://brandweave.ai/blog"
