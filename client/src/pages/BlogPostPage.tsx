...
const BlogPostPage: React.FC = () => {
  ...
  const pageTitle = post.title + " | Brandweave AI Blog";
  const pageDescription = "Read the blog post \"" + post.title + "\" on Brandweave AI. Discover insights on AI brand strategy, intelligence, and the future of brand perception.";
  const pageCanonical = "https://brandweave.ai/blog/" + (slug || "");
  ...
  return (
    <>
      <SEO
        ...
        keywords="AI brand strategy, brand intelligence, AI brand perception, blog, brandweave insights"
